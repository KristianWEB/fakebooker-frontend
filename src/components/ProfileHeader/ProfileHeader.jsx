...
import MessageIconSvg from "../../assets/icons/chat---messages-icon.svg";
import GearIconSvg from "../../assets/icons/gear-option.svg";
import AddFriendSvg from "../../assets/icons/add-friend-icon.svg";
